    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-main px-4 py-12">
      <div className="max-w-md w-full space-y-8 p-10 bg-bg-card rounded-2xl shadow-2xl border border-border">
        <div className="text-center">
          ...
          <p className="mt-3 text-sm text-text-muted">Register your clinic to get started</p>
        </div>
        <form className="mt-10 space-y-4" onSubmit={handleSubmit}>
          <div>
            <label className="block text-xs font-bold text-text-dim uppercase tracking-widest mb-1.5 ml-1">Clinic Name</label>
            <input
              type="text"
              required
              ...
              placeholder="MediCenter Clinic"
              value={formData.organizationName}
              onChange={(e) => setFormData({ ...formData, organizationName: e.target.value })}
            />
          </div>
          <div>
            <label className="block text-xs font-bold text-text-dim uppercase tracking-widest mb-1.5 ml-1">Your Full Name</label>
            <input
              type="text"
              required
              className="block w-full px-4 py-3 bg-bg-active border border-border rounded-lg text-text-primary placeholder:text-text-dim focus:outline-none focus:ring-2 focus:ring-brand/50 focus:border-brand transition-all"
          ...
          <div>
            <label className="block text-xs font-bold text-text-dim uppercase tracking-widest mb-1.5 ml-1">Role</label>
            <select
              className="block w-full px-4 py-3 bg-bg-active border border-border rounded-lg text-text-primary focus:outline-none focus:ring-2 focus:ring-brand/50 focus:border-brand transition-all appearance-none"
              value={formData.role}
        ...
        <div className="text-center pt-4">
          <Link to="/login" className="text-sm font-medium text-text-muted hover:text-brand transition-colors">
